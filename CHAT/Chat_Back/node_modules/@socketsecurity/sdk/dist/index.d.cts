...
export type SocketSdkErrorType<T extends SocketSdkOperations> = OpErrorType<operations[T]>;
...
export declare class SocketSdk {
    ...
    }, concurrencyLimit?: number): AsyncGenerator<BatchPackageFetchResultType>;
